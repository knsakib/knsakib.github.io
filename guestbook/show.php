...
if (mysql_connect('ec2-54-187-216-239.us-west-2.compute.amazonaws.com','sakib','sakibWeb') && mysql_select_db('messages')){
...
// @ sign before 'mysql_connect' and 'mysql_select_db' force not to show default error message
    ...
    $entries = mysql_query("SELECT * FROM messages ORDER BY `timestamp` DESC");
...
while ( $entries_row=mysql_fetch_array($entries) )  
{     
